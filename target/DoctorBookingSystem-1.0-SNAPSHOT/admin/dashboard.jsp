...
<%
    ...
    for (Appointment a : allAppts) {
        ...
        else if ("confirmed".equals(a.getStatus())) confirmedAppts++;
        else if ("cancelled".equals(a.getStatus()) || "rejected".equals(a.getStatus())) cancelledAppts++;
        else if ("completed".equals(a.getStatus())) completedAppts++;
    }
%>
        ...
        <div class="content-area">
            ...
            <div class="content-card mt-5">
                <div class="content-card-header">
                    <h3><i class="fa-solid fa-chart-pie" style="color: var(--primary);"></i> Platform Analytics</h3>
                </div>
                <div class="content-card-body">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div style="background: var(--bg-light); padding: 15px; border-radius: 8px;">
                            <canvas id="specializationChart" width="400" height="250"></canvas>
                        </div>
                        <div style="background: var(--bg-light); padding: 15px; border-radius: 8px;">
